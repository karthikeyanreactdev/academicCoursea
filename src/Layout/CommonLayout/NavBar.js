...
const NavBar = (props) => {
    ...
    // Institute signup/signin
    const [authToggle, setAuthToggle] = useState(false)
    const dropDownuserAuth = () => setAuthToggle((prevState) => !prevState);
                ...
                <Container fluid className="custom-container">
                    ...
                    <ul className="header-menu list-inline d-flex align-items-center mb-0">
                        ...
                        <Dropdown
                            ...
                            isOpen={authToggle}
                            toggle={dropDownuserAuth}
                            className="list-inline-item"
                        >
                            <DropdownToggle to="#" className="header-item" id="userdropdown" type="button" tag="a"
                                aria-expanded="false">
                                <span className="d-none d-md-inline-block fw-medium">Institute</span>
                            </DropdownToggle>
